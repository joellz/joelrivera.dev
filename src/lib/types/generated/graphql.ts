...
export type Employer = Entity & Node & {
  ...
  /** Get the document in other stages */
  documentInStages: Array<Employer>;
  /** This is the duration for how long you were at the company. (ie: 2015 - 2019) */
  duration?: Maybe<Scalars['String']['output']>;
  /** List of Employer versions */
  history: Array<Version>;
  /** The unique identifier */
  id: Scalars['ID']['output'];
...
export type EmployerCreatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type EmployerDocumentInStagesArgs = {
  includeCurrent?: Scalars['Boolean']['input'];
  inheritLocale?: Scalars['Boolean']['input'];
  stages?: Array<Stage>;
};
...
export type EmployerHistoryArgs = {
  limit?: Scalars['Int']['input'];
  skip?: Scalars['Int']['input'];
  stageOverride?: InputMaybe<Stage>;
};
...
export type EmployerPublishedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type EmployerScheduledInArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type EmployerUpdatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};

export type EmployerConnectInput = {
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Document to connect */
...
export type EmployerCreateManyInlineInput = {
  /** Connect multiple existing Employer documents */
  connect?: InputMaybe<Array<EmployerWhereUniqueInput>>;
  /** Create and connect multiple existing Employer documents */
  create?: InputMaybe<Array<EmployerCreateInput>>;
};

export type EmployerCreateOneInlineInput = {
  /** Connect one existing Employer document */
  connect?: InputMaybe<EmployerWhereUniqueInput>;
  /** Create and connect one Employer document */
...
/** Identifies documents */
export type EmployerManyWhereInput = {
  /** Logical AND on all given filters. */
  ...
  documentInStages_every?: InputMaybe<EmployerWhereStageInput>;
  documentInStages_none?: InputMaybe<EmployerWhereStageInput>;
  documentInStages_some?: InputMaybe<EmployerWhereStageInput>;
  duration?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
...
export enum EmployerOrderByInput {
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
...
export type EmployerUpdateManyInlineInput = {
  /** Connect multiple existing Employer documents */
  connect?: InputMaybe<Array<EmployerConnectInput>>;
  /** Create and connect multiple Employer documents */
  create?: InputMaybe<Array<EmployerCreateInput>>;
  /** Delete multiple Employer documents */
  delete?: InputMaybe<Array<EmployerWhereUniqueInput>>;
  /** Disconnect multiple Employer documents */
  disconnect?: InputMaybe<Array<EmployerWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing Employer documents */
  set?: InputMaybe<Array<EmployerWhereUniqueInput>>;
  /** Update multiple Employer documents */
  update?: InputMaybe<Array<EmployerUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple Employer documents */
  upsert?: InputMaybe<Array<EmployerUpsertWithNestedWhereUniqueInput>>;
};

export type EmployerUpdateManyInput = {
  description?: InputMaybe<Scalars['String']['input']>;
  duration?: InputMaybe<Scalars['String']['input']>;
  link?: InputMaybe<Scalars['String']['input']>;
  name?: InputMaybe<Scalars['String']['input']>;
...
export type EmployerUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: EmployerUpdateManyInput;
  /** Document search */
  where: EmployerWhereInput;
};

export type EmployerUpdateOneInlineInput = {
  /** Connect existing Employer document */
  connect?: InputMaybe<EmployerWhereUniqueInput>;
  /** Create and connect one Employer document */
  create?: InputMaybe<EmployerCreateInput>;
  /** Delete currently connected Employer document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Disconnect currently connected Employer document */
  disconnect?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single Employer document */
  update?: InputMaybe<EmployerUpdateWithNestedWhereUniqueInput>;
  /** Upsert single Employer document */
  upsert?: InputMaybe<EmployerUpsertWithNestedWhereUniqueInput>;
};

export type EmployerUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
...
export type EmployerUpsertInput = {
  /** Create document if it didn't exist */
...
export type EmployerUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: EmployerUpsertInput;
  /** Unique document search */
  where: EmployerWhereUniqueInput;
};

/** This contains a set of filters that can be used to compare values internally */
export type EmployerWhereComparatorInput = {
  /** This field can be used to request to check if the entry is outdated by internal comparison */
  outdated_to?: InputMaybe<Scalars['Boolean']['input']>;
};
...
/** The document in stages filter allows specifying a stage entry to cross compare the same document between different stages */
export type EmployerWhereStageInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<EmployerWhereStageInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<EmployerWhereStageInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<EmployerWhereStageInput>>;
  /** This field contains fields which can be set as true or false to specify an internal comparison */
  compareWithParent?: InputMaybe<EmployerWhereComparatorInput>;
  /** Specify the stage to compare with */
  stage?: InputMaybe<Stage>;
};
...
export type Mutation = {
  ...
  /** Delete one employer from _all_ existing stages. Returns deleted document. */
  ...
  /**
   * Delete many Employer documents
   * @deprecated Please use the new paginated many mutation (deleteManyEmployersConnection)
   */
  deleteManyEmployers: BatchPayload;
  /** Delete many Employer documents, return deleted documents */
  deleteManyEmployersConnection: EmployerConnection;
  /**
  ...
  /** Publish one employer */
  publishEmployer?: Maybe<Employer>;
  /**
  ...
  /**
   * Publish many Employer documents
   * @deprecated Please use the new paginated many mutation (publishManyEmployersConnection)
   */
  publishManyEmployers: BatchPayload;
  /** Publish many Employer documents */
  publishManyEmployersConnection: EmployerConnection;
  /**
  ...
  /** Schedule to publish one employer */
  schedulePublishEmployer?: Maybe<Employer>;
  ...
  /** Unpublish one employer from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  scheduleUnpublishEmployer?: Maybe<Employer>;
  ...
  /** Unpublish one employer from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishEmployer?: Maybe<Employer>;
  /**
  ...
  /**
   * Unpublish many Employer documents
   * @deprecated Please use the new paginated many mutation (unpublishManyEmployersConnection)
   */
  unpublishManyEmployers: BatchPayload;
  /** Find many Employer documents that match criteria in specified stage and unpublish from target stages */
  unpublishManyEmployersConnection: EmployerConnection;
  /**
   ...
   * @deprecated Please use the new paginated many mutation (updateManyEmployersConnection)
   */
  updateManyEmployers: BatchPayload;
  /** Update many Employer documents */
  updateManyEmployersConnection: EmployerConnection;
  /**
   * Update many posts
...
export type MutationDeleteManyEmployersArgs = {
  where?: InputMaybe<EmployerManyWhereInput>;
};


export type MutationDeleteManyEmployersConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type MutationPublishEmployerArgs = {
  to?: Array<Stage>;
  where: EmployerWhereUniqueInput;
};
...
export type MutationPublishManyEmployersArgs = {
  to?: Array<Stage>;
  where?: InputMaybe<EmployerManyWhereInput>;
};


export type MutationPublishManyEmployersConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  from?: InputMaybe<Stage>;
...
export type MutationSchedulePublishEmployerArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']['input']>;
  releaseId?: InputMaybe<Scalars['String']['input']>;
  to?: Array<Stage>;
  where: EmployerWhereUniqueInput;
...
export type MutationScheduleUnpublishEmployerArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']['input']>;
  releaseId?: InputMaybe<Scalars['String']['input']>;
  where: EmployerWhereUniqueInput;
...
export type MutationUnpublishEmployerArgs = {
  from?: Array<Stage>;
  where: EmployerWhereUniqueInput;
};
...
export type MutationUnpublishManyEmployersArgs = {
  from?: Array<Stage>;
  where?: InputMaybe<EmployerManyWhereInput>;
};


export type MutationUnpublishManyEmployersConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  from?: Array<Stage>;
...
export type MutationUpdateManyEmployersArgs = {
  data: EmployerUpdateManyInput;
  where?: InputMaybe<EmployerManyWhereInput>;
};


export type MutationUpdateManyEmployersConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  data: EmployerUpdateManyInput;
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type MutationUpsertEmployerArgs = {
  upsert: EmployerUpsertInput;
  where: EmployerWhereUniqueInput;
};
...
export type Project = Entity & Node & {
  ...
  /** User that last published this document */
  publishedBy?: Maybe<User>;
  /** This is the repo url to the source code of the project. */
...
export type Query = {
  ...
  /** Retrieve document version */
  employerVersion?: Maybe<DocumentVersion>;
  /** Retrieve multiple employers */
...
export type QueryEmployerVersionArgs = {
  where: VersionWhereInput;
};
...
export type QueryEmployersArgs = {
  ...
  last?: InputMaybe<Scalars['Int']['input']>;
  locales?: Array<Locale>;
  orderBy?: InputMaybe<EmployerOrderByInput>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  stage?: Stage;
...
export type QueryEmployersConnectionArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type ScheduledOperationAffectedDocument = Asset | Employer | Post | Project;
